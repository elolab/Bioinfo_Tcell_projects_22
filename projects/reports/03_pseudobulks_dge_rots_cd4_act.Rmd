...
![Pseudobulks](figs/paper_fig2_pseudobulk.png)
...
# Save objects
saveRDS(dge.bulks, paste(dirs2save[3], "objects/dge.bulks.rds", sep="/"))
saveRDS(dge.sc, paste(dirs2save[3], "objects/dge.sc.rds", sep="/"))
saveRDS(dge.ps, paste(dirs2save[3], "objects/dge.ps.rds", sep="/"))
saveRDS(top500.genes, paste(dirs2save[3], "objects/top500.genes.rds", sep="/"))
saveRDS(aucc, paste(dirs2save[3], "objects/aucc.results", sep="/"))
saveRDS(seu, paste(dirs2save[3], "objects/seu.rds", sep="/"))
saveRDS(ps, paste(dirs2save[3], "objects/ps.rds", sep="/"))
saveRDS(bulk, paste(dirs2save[3], "objects/bulk.rds", sep="/"))
saveRDS(func.list, paste(dirs2save[3], "objects/func.list.rds", sep="/"))
