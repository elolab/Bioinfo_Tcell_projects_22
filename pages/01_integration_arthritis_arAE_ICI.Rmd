...
clts2celltype[["unint"]] <- data.frame(rbind(table(seu@meta.data$unint_seurat_clusters, seu@meta.data$cell.types.orig)))
...
new_clts <- list("unint"=seu@meta.data$unint_seurat_clusters, 
...
if(!dir.exists(res_objs)) dir.create(res_dirs, recursive=TRUE)
